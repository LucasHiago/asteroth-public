...
- mana
- velocidade de disparo de habilidades

A fama é mais do que um número. **Cada ponto de fama adquirido se traduz em 0,005 pontos de bônus** aplicados diretamente aos seus status. A primeira grande marca acontece em **1.000 pontos de fama**, momento em que os pontos de bônus são distribuídos de forma única para cada personagem.
...
Existem diversas maneiras de adquirir fama:
...
Em um confronto entre um time vitorioso composto por **healer, tank e assassino**, contra três **DPS**:
...
*Voltar para o canon do mundo em [`LORE.md`](LORE.md) e o panteão dos governantes em [`GOVERNANTES.md`](GOVERNANTES.md).*
